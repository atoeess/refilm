                    ...
                    <form action="{{ route('film.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="trailer" class="w-full rounded-xl border px-4 py-3 text-sm"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="deskripsi" rows="3" class="w-full rounded-xl border px-4 py-3 text-sm"></textarea>
                            </div>

                            {{-- Sinopsis --}}
                            <div class="md:col-span-2">
                                <label class="block mb-2 text-sm font-semibold">Sinopsis</label>
                                <textarea name="sinopsis" rows="4" class="w-full rounded-xl border px-4 py-3 text-sm"></textarea>
                            </div>
                        ...
                        <div class="flex justify-between mt-10">
                            ...
                            <button type="submit" class="px-5 py-3 rounded-xl bg-blue-600 text-white font-bold">
                                Simpan
                            </button>
                        </div>

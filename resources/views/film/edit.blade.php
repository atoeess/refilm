                ...
                <form action="{{ route('film.update', $film->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="tahun" value="{{ $film->tahun }}"
                                class="w-full rounded-xl border px-4 py-3 text-sm">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="deskripsi" rows="3"
                                class="w-full rounded-xl border px-4 py-3 text-sm">{{ $film->deskripsi }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="sinopsis" rows="4"
                                class="w-full rounded-xl border px-4 py-3 text-sm">{{ $film->sinopsis }}</textarea>
                        </div>
                    ...
                    <div class="flex justify-between mt-10">
                        ...
                        <button type="submit"
                            class="px-5 py-3 rounded-xl bg-blue-600 text-white font-bold shadow">
                            Update
                        </button>
                    </div>

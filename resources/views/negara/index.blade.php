        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Negara</h6>
                </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h6 class="text-uppercase text-secondary font-weight-bolder mb-0">COUNTRY TABLE</h6>
                            <a href="{{ route('negara.create') }}" class="btn bg-gradient-dark"
                                    ...
                                    <tbody>
                                        @forelse ($negaras as $negara)
                                            <tr>
                                                <td class="ps-4">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $negara->nama_negara }}</h6>
                                                    </div>
                                                <td class="align-middle text-center">
                                                    <a href="{{ route('negara.edit', $negara->id) }}"
                                                        ...
                                                        data-toggle="tooltip" title="Edit Negara">
                                                        <i class="fas fa-edit me-1"></i> Edit
                                                    </a>

                                                    <form action="{{ route('negara.destroy', $negara->id) }}"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            data-toggle="tooltip" title="Hapus Negara">

                ...
                @foreach ($favorites as $fav)
                    ...
                    hover:scale-[1.04] hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute top-2 right-2 bg-black/60 px-2 py-1 rounded-full backdrop-blur-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#ff4b91" viewBox="0 0 24 24" stroke="none"
                                    class="w-5 h-5">

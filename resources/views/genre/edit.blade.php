    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Edit Genre</h6>
            </nav>
        </div>
    </nav>
    ...
    <div class="w-full px-6 py-6 mx-auto">
        <div class="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-xl rounded-2xl bg-clip-border">
            ...
            <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid border-gray-200 rounded-t-2xl flex justify-between items-center">
                <h6 class="text-lg font-bold text-slate-700">Edit Data Genre</h6>
            ...
            <div class="flex-auto p-6">
                ...
                <form action="{{ route('genre.update', $genre->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="nama_genre" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700">
                            Nama Genre
                        </label>
                        ...
                        <input type="text"
                            ...
                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white
                            text-sm block w-full rounded-lg border border-gray-300 bg-white px-3 py-2
                            text-gray-700 placeholder:text-gray-500 focus:border-blue-500"

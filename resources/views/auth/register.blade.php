...
<head>
    <meta charset="UTF-8">
    <title>Daftar Akun — ReFilm</title>
...
<body class="bg-[#0f0f0f] min-h-screen flex items-center justify-center font-['Comfortaa'] relative overflow-hidden">
    ...
    <div class="absolute -top-32 -left-20 w-80 h-80 bg-blue-600/30 blur-[120px] rounded-full"></div>
    <div class="absolute bottom-0 right-0 w-72 h-72 bg-blue-500/25 blur-[110px] rounded-full"></div>
        ...
        <div class="mb-4">
            ...
            <div class="relative">
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Nama lengkap"
                    class="w-full bg-white/5 border border-gray-700 rounded-xl px-4 py-2 pl-10
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 15l-4-4m0 0l4-4m-4 4h8" />
                </svg>
            </div>
        </div>

        <button type="submit"
            class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 w-full rounded-xl
                   shadow-lg hover:shadow-blue-500/40 transition-all duration-200">
            Daftar
        </button>

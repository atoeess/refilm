...
<body
    class="bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex items-center justify-center min-h-screen font-['Comfortaa']">

    <form action="{{ route('register.post') }}" method="POST"
        class="bg-white p-8 rounded-3xl shadow-xl w-80 sm:w-96 animate-fadeIn">
        @csrf
        ...
        <div class="mb-4 relative">
            ...
            <input type="text" name="name" value="{{ old('name') }}" placeholder="Nama lengkap"
                class="w-full border border-purple-200 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-300 shadow-sm"
                required>
        </div>
